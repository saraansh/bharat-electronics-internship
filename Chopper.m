function [Output, NumSegments] = Chopper(Input, WindowLength, Window, HoppingSize)
...
Index = (repmat(1:WindowLength,NumSegments,1) + ...
    repmat((0:(NumSegments-1))'*HoppingSamples,1,WindowLength))';
